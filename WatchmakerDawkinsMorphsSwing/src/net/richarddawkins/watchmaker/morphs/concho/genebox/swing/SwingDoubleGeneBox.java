...
public class SwingDoubleGeneBox extends SwingTextGeneBox
        implements DoubleGeneBox {
    /**
     * 
     */
    ...
    public SwingDoubleGeneBox(AppData appData) {
        super(appData);
    }
    ...
    public void setValue(Double value) {
        valueLabel
                .setText((value > 0 && ((DoubleGene) gene).isShowPositiveSign()
                        ? "+" : "") + df.format(value));
        repaint();
    }
