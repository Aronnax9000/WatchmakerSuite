...
public abstract class SwingMenuBuilder implements MenuBuilder {
	...
	/**
	 * Subclasses should call menuBar.repaint() after adding their own menu items.
	 */
	...
	protected WatchmakerMenu buildOperationMenu() {
		...
		menu.add(new SwingWatchmakerMenuItem(new AbstractAction("Hopeful Monster (New Random Start)", newRandomStartIcon) {
			private static final long serialVersionUID = 1L;
